 ...
 *
 */
public class VarOwnerMeter_DDPrice extends ExpressManager{
	...
	{
		Map map = new HashMap();
		String hql="from OwnerMeterRecordEO where meterType='电表' and areaId="+areaId+" and recordMonth='"+recordMonth+"'";
