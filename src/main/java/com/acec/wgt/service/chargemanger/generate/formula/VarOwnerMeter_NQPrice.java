 ...
 *
 */
public class VarOwnerMeter_NQPrice extends ExpressManager{
	...
	{
		Map map = new HashMap();
		String hql="from OwnerMeterRecordEO where meterType='暖气表' and areaId="+areaId+" and recordMonth='"+recordMonth+"'";
