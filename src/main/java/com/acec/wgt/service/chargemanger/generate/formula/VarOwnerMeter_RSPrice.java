 ...
 *
 */
public class VarOwnerMeter_RSPrice extends ExpressManager{
	...
	{
		Map map = new HashMap();
		String hql="from OwnerMeterRecordEO where meterType='热水表' and areaId="+areaId+" and recordMonth='"+recordMonth+"'";
