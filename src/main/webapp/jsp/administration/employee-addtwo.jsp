...
<body>
    <div class="add">
    	<div class="add_area">
          ...
          <s:hidden name="entity.employeetype" value="yx"></s:hidden>
		  ...
		  <tr>
		    ...
		    <td ><s:textfield name="entity.entrydate" id="entrydate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" size="10" readonly="true" theme="simple"></s:textfield> </td>
		  	<td >签订合同类型 </td>
		    <td ><s:radio name="entity.contracttype" id="contracttype" list="#{'1':'劳动合同','0':'劳务合同'}" value="1" theme="simple"></s:radio></td>
		  </tr>	
		  <tr>
		  	<td >购买意外伤害险 </td>
		    <td ><s:radio name="entity.insurance" id="insurance" list="#{'1':'是','0':'否'}" value="1" theme="simple"></s:radio></td>
		    <td >离职时间</td>
