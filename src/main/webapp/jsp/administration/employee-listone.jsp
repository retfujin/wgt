...
<script type="text/javascript">
	function add(){
		var vReturnValue = window.showModalDialog("employee!addone.action","",
	...
	function edit(id) {
		var vReturnValue = window.showModalDialog("employee!editone.action?entity.id=" + id,"",
				"help:0;resizable:0;status=0;scroll=yes;scrollbars=yes;dialogWidth=800px;dialogHeight=400px;center=true");
		if ("success" == vReturnValue)
			window.location.reload();
	}
...
<body>
<form class="search_form" name="form1" action="employee!listone.action" method="post">
	...
	劳动合同到期<s:textfield name="b_labordate" id="b_labordate" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" size="8" theme="simple"/>~<s:textfield name="e_labordate" id="e_labordate" readonly="true"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" size="8" theme="simple"/>
   	...
   	<div class="table_area">
           ...
           <table class="table_border" width="99%" cellpadding="2" cellspacing="1" align="center">
       		<tr align="center">
				...
				<td class="td_header">劳动合同期限</td>
				<td class="td_header">劳动合同<Br>签订期限</td>
            ...
            <tr>
                ...
                <td class="td_c">${thetitle}&nbsp;</td>
                <td class="td_c">${brithday}&nbsp;</td>
                <td class="td_c">${age}&nbsp;</td>
                <td class="td_c">${phone}&nbsp;</td>
                <td class="td_c">${entrydate}&nbsp;</td>
                <td class="td_c">${beginlabordate}至${endlabordate}&nbsp;</td>
                <td class="td_c">${endyear}年&nbsp;</td>
           ...
           <div class="table_footer" id="footer">
           	<a href="###" class="add fl" onclick="add()">新增</a>
				...
				<s:if test="page.totalPages>1">
					<a href="employee!listone.action?page.pageNo=1&page.orderBy=${page.orderBy}&page.order=${page.order}">首页</a>
				</s:if><s:else><a href="#">首页</a></s:else>
				<s:if test="page.hasPre">
					<a href="employee!listone.action?page.pageNo=${page.prePage}&page.orderBy=${page.orderBy}&page.order=${page.order}">上一页</a>
				</s:if><s:else><a href="#">上一页</a></s:else>
				<s:if test="page.hasNext">
					<a href="employee!listone.action?page.pageNo=${page.nextPage}&page.orderBy=${page.orderBy}&page.order=${page.order}">下一页</a>
				</s:if><s:else><a href="#">下一页</a></s:else>
				<s:if test="page.totalPages>1">
					<a href="employee!listone.action?page.pageNo=${page.totalPages}&page.orderBy=${page.orderBy}&page.order=${page.order}">尾页</a>
