...
<body>
	<div class="add">
    	<div class="add_area">
            ...
            <form id="ff" method="post" action="position!save.action" name="frmAdd" >
                ...
                <table class="add_table" cellpadding="2" cellspacing="1" align="center" width="99%" align="center" >
                    <tr>
                        <td height="35" align="center">岗位名称</td>
                        <td><s:textfield name="entity.name" id="name" theme="simple" /></td>
                    </tr>
                    <tr>
                        <td height="35" align="center">描述</td>
                        <td><s:textfield name="entity.description" id="description" theme="simple" /></td>
                    </tr>
                    <tr>
