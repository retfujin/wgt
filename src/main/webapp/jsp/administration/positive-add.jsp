...
<%
	String employedid = request.getParameter("id")!=null ? request.getParameter("id") : "0"; 
%>
<body>
    <div class="add">
    	<div class="add_area">
		  ...
		  <tr>
		    ...
		    <td ><s:select name="entity.name" id="name" list="employedList" listKey="name" listValue="name" theme="simple"></s:select> </td>
		    <td >部门 </td>
