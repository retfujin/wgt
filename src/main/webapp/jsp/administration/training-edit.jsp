    ...
    <div class="add">
    	<div class="add_area">
		  ...
		  <tr>
		    ...
		    <input type="text" name="trainingdate" readonly="readonly" value="${trainingdate}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" size="10" /> </td>
		    <td ><input type="text"  name="content" value="${content}" size="40" /> </td>
		    <td ><input type="text"  name="unit" value="${unit}"/> </td>
		    <td ><input type="text"  name="results" value="${results}" size="10" /> </td>
		  </tr> 
		   </s:iterator>
		  <tr class="footer">
                        <td colspan="4">
