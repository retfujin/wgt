...
<script type="text/javascript">
	...
	function edit(id) {
		$.post("vacate!getInfo.action", {'entity.id': id},     
				   function (data, textStatus){
						...
						if(!responseText.success){
							...
							var vReturnValue = window.showModalDialog("vacate!edittwo.action?entity.id=" + id,"",
							"help:0;resizable:0;status=0;scroll=yes;scrollbars=yes;dialogWidth=600px;dialogHeight=600px;center=true");
...
<body>
<form class="search_form" name="form1" action="vacate!listtwo.action" method="post">
   	...
   	<div class="table_area">
           ...
           <table class="table_border" width="99%" cellpadding="2" cellspacing="1" align="center">
            ...
            <tr>
                    ...
                    <td class="td_c">
                    	<a href="#" onclick="edit('${id}','${auditdate}','${approvaldate}','${state}')"><img border="0" alt="编辑" src="/images/change.png" ></a> 
           ...
           <div class="table_footer" id="footer">
				...
				<s:if test="page.totalPages>1">
					<a href="vacate!listtwo.action?page.pageNo=1&page.orderBy=${page.orderBy}&page.order=${page.order}">首页</a>
				</s:if><s:else><a href="#">首页</a></s:else>
				<s:if test="page.hasPre">
					<a href="vacate!listtwo.action?page.pageNo=${page.prePage}&page.orderBy=${page.orderBy}&page.order=${page.order}">上一页</a>
				</s:if><s:else><a href="#">上一页</a></s:else>
				<s:if test="page.hasNext">
					<a href="vacate!listtwo.action?page.pageNo=${page.nextPage}&page.orderBy=${page.orderBy}&page.order=${page.order}">下一页</a>
				</s:if><s:else><a href="#">下一页</a></s:else>
				<s:if test="page.totalPages>1">
					<a href="vacate!listtwo.action?page.pageNo=${page.totalPages}&page.orderBy=${page.orderBy}&page.order=${page.order}">尾页</a>
