            ...
            <form id="ff" method="post" action="area!save.action" name="frmAdd" >
                <table class="add_table" cellpadding="2" cellspacing="1" align="center" width="99%" align="center" >
                    <tr>
                        ...
                        <td><s:textfield name="entity.id" id="id" size="25"	readonly="true" maxlength="20" theme="simple" cssClass="locked"/></td>
                    ...
                    <tr>
                        ...
                        <td><s:textfield name="entity.diskTime" id="diskTime" readonly="true" size="25" maxlength="20" theme="simple" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
                        	 <s:param name="value" ><s:date name="entity.diskTime" format="yyyy-MM-dd" /></s:param></s:textfield>
                        	</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="poolRatio"	id="poolRatio" size="25" maxlength="20" value="${entity.poolRatio }" /></td>
                    </tr>
                    <tr>
