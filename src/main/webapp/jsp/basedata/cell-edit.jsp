		...
		$(function(){
			$('#ff').form({
				onSubmit: function(){
					...
					if(!checkOnlyNum(frm.cell,"单元数"))//只能是数字的验证
					{
					...
					if(!checkOnlyNum(frm.houseName,"房号"))//只能是数字的验证
					{
						document.getElementById('houseName').select();
						return false;
					}	
    	...
    	<div class="add_area">
            ...
            <form id="ff" method="post" action="cell!save.action" name="frmAdd">
                ...
                <table class="add_table" cellpadding="2" cellspacing="1" align="center" width="99%" align="center" >
                    <tr>
                        <td height="35" align="center">小区名称</td>
                        <td><s:textfield name="entity.areaName"	theme="simple" readonly="true" cssClass="locked" /></td>
                        <td height="35" align="center">楼栋名称</td>
                        <td><s:textfield name="entity.edificeName" theme="simple" readonly="true" cssClass="locked" /></td>
                    </tr>
                    <tr>
                        <td height="35" align="center">单元<font color="red">*</font></td>
                        <td><s:textfield name="entity.cell" id="cell" size="10" maxlength="10" theme="simple" /></td>
                        <td height="35" align="center">房号</td>
                        <td><s:textfield name="entity.houseName" id="houseName" readonly="true" cssClass="locked" theme="simple" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>${entity.houseType}<s:hidden name="entity.houseType"></s:hidden></td>
                    ...
                    <tr>
                    	...
                    	<td colspan="3"><s:textarea name="entity.remark" id="remark" cols="35" rows="3" theme="simple" /></td>
                    </tr>
                    <tr>
                    	<td colspan="4">
                    		<div id="owner" style="display: none;">
			                    <table class="add_table" cellpadding="2" cellspacing="1" align="center" width="99%" align="center" >
									...
									<tr>
										...
										<td ><s:textfield name="entity.paperNum" id="paperNum" onblur="CodeValid();" theme="simple" /></td>
									...
									<tr>
										...
										<td><s:textfield name="entity.inDate" id="inDate" theme="simple" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" >
											<s:param name="value"><s:date name="entity.inDate" format="yyyy-MM-dd"/></s:param>
											</s:textfield></td>
									</tr>
									</table>
								</div>
                    ...
                    <tr class="footer">
                        <td colspan="4">
                        	...
                        	<s:hidden name="entity.edificeId"></s:hidden>
