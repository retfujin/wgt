...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.上传只能添加新的内容，已有房间信息不会被覆盖。请注意不要重复导入房间信息。请按照格式添加。<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.上传文件类型只能为Excel文件！<br><br>
</td>
</tr>
<tr><td height="40" align="center">
	<form action="cell!downExcel.action" method="post" name="form2"> 
...
<tr><td height="40" align="center">
    <form id="ff" action="cell!uploadExcel.action" method ="post" enctype="multipart/form-data" name="form1" >
