...
$(document).ready(function(){
	  tabpanel = new TabPanel({
		...
		items : [{
			...
			html:'<iframe id="tab1Frame" src="/basedata/cell!list.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: true
		},{
			id:'tab2',
			title:'房间状态',
			icon:'/tabpanel/image/read-y.gif',
			html:'<iframe id="tab2Frame" src="/basedata/cellstate!query.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: true,
			lazyload : true
		},{
			id:'tab3',
			title:'入住率统计',
			icon:'/tabpanel/image/read-y.gif',
			html:'<iframe id="tab3Frame" src="/basedata/cell!ratelist.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: true,
			lazyload : true
		}]
	});
