...
<table width="90%" border="0" cellspacing="0" cellpadding="0"
	...
	<TR>
		<TH height="25" align="left">小区楼栋</TH>
	</TR>
</table>
...
<table width="90%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<td colspan="2"><s:textfield name="id" id="id" size="25"
			maxlength="20" theme="simple" required="true" /><font color="red">*</font>可由字母数字组成</td>
	</tr>
	<tr>
		<td width="20%" height="30">
	...
	<tr>
		...
		<td colspan="2"><s:select name="entity.area.id" id="areaId"
			list="viewList" listKey="id" listValue="areaName" theme="simple"></s:select><font
			color="red">*</font></td>
	</tr>
	<tr>
		<td width="20%" height="25">
		...
		<td colspan="2"><s:textfield name="entity.buildNum" id="buildNum"
			size="25" maxlength="20" theme="simple" required="true" value="0.1" /><font
			color="red">*</font></td>
	</tr>
	<tr>
		<td width="20%" height="25">
		...
		<td colspan="2"><s:textfield name="entity.cellNum" id="cellNum"
			size="25" maxlength="20" theme="simple" value="1" /><font color="red">*</font></td>
	</tr>
	<tr>
		<td width="20%" height="25">
	...
	<tr>
		...
		<td colspan="2"><select name="entity.edificeUse" id="edificeUse">
