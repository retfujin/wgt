...
&nbsp;&nbsp;&nbsp;&nbsp;2.上传只能添加新的内容，已有信息不会被覆盖。请注意不要重复导入相同信息。请按照格式添加。<br>
&nbsp;&nbsp;&nbsp;&nbsp;3.上传文件类型只能为Excel文件！<br><br>
</td>
</tr>
<tr>
	<td height="40" align="center">
		<form action="garage!downCarportExcel.action" method="post" name="form2">   	
	  		请下载车位期初收费模版，填写完毕后上传。  
...
<tr>
	<td height="40" align="center">
    <form id="my_form" action="garage!uploadCarportExcel.action" method ="post" enctype="multipart/form-data" name="form1">
          &nbsp;车位期初收费信息导入：<input type="file" name="theFile" id="file" />
