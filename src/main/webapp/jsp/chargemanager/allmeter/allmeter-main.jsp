...
$(document).ready(function(){
	...
	//	border:'none',
		...
		items : [{
			...
			html:'<iframe id="callIframe1" src="/chargemanager/allmeter/allmeter!listquery.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: false
		}//,{
		//	id:'tab2',
		//	title:'换表记录',
		//	icon:'/tabpanel/image/read-y.gif',
		//	html:'<iframe id="callIframe2" src="/chargemanager/allmeter/allmeter!oldmeterlistquery.action" width="100%" height="100%" frameborder="0"></iframe>',
		//	closable: false
		//}
		]
	});
