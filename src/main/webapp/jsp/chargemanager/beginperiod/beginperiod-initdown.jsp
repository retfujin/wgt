...
<tr><td height="40" align="center">
	<form action="beginperiod!downExcel.action" method="post" name="form2"> 
	请选择小区<s:select list="viewList" name="areaId" listKey="id" listValue="areaName" theme="simple"></s:select> 
  	
  请下载信息模版，填写完毕后上传。  
		<input name="cc" value="下载基础信息模板" type="submit" />	
</form>  </td></tr>

<tr><td height="40" align="center">
    <form action="beginperiod!uploadExcel.action" method ="post" enctype="multipart/form-data" name="form1" onSubmit="return formCheck()">
          &nbsp;期初数据导入：<input type="file" name="theFile" id="file" />
          <input name="dd" type="submit" value="导入"/><br />
