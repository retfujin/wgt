           ...
           <table class="table_border" width="99%" cellpadding="2" cellspacing="1" align="center">
       		<tr>
                ...
                <td class="td_c">
                	...
                	<form action="manualgenerate!downown.action" method="post" name="form2"> 
            ...
            <tr  class="footer">
            	<td height="40" align="center" colspan="3">
				    <form action="manualgenerate!uploadown.action" method ="post" enctype="multipart/form-data" name="form1" onSubmit="return formCheck()">
