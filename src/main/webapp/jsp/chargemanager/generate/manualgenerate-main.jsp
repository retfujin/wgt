...
$(document).ready(function(){
	...
	//	border:'none',
		...
		items : [{
			...
			html:'<iframe id="callIframe1" src="/chargemanager/generate/manualgenerate!indexo.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: false
		},{
			id:'tab2',
			title:'历史费用导入',
			icon:'/tabpanel/image/read-y.gif',
			html:'<iframe id="callIframe2" src="/chargemanager/generate/manualgenerate!indext.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: false
		}]
	});
});
