...
$(document).ready(function(){
	...
	//	border:'none',
		...
		items : [{
			...
			html:'<iframe id="callIframe1" src="/chargemanager/ownermeter/ownermeter!listquery.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: false
		}
		...
		//	title:'换表记录',
		//	icon:'/tabpanel/image/read-y.gif',
		//	html:'<iframe id="callIframe2" src="/chargemanager/ownermeter/ownermeter!oldmeterlistquery.action" width="100%" height="100%" frameborder="0"></iframe>',
		//	closable: false
		//}
