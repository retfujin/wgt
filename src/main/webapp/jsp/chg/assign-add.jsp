...
<div class="add">
    	<div class="add_area">
           ...
           <form id="ff" method="post" action="assign!saveArea3.action" name="formadd" >
               <s:token></s:token>
                <table class="add_table" cellpadding="2" cellspacing="1" align="center" width="99%" align="center" >
                    <tr>
                        ...
                        <td><s:select name="areaId" id="areaId" list="viewList" headerKey="" headerValue="==请选择小区==" listKey="id" listValue="areaName" theme="simple" onchange="getDchargeBaseId()"></s:select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="35" align="center">交款人<font color="red">*</font></td>
