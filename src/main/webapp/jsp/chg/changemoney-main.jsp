...
$(document).ready(function(){
	...
	//	border:'none',
		...
		items : [{
			...
			html:'<iframe id="callIframe1" src="/chg/changemoney!index.action" width="100%" height="100%" frameborder="0"></iframe>',
			closable: true
		},{
			id:'tab2',
			title:'收款调整',
			icon:'/tabpanel/image/read-y.gif',
			html:'<iframe id="callIframe2" src="/chg/pay-receiptquery.action?toType=del" width="100%" height="100%" frameborder="0"></iframe>',
			closable: true
		}]
	});
});
