...
%> 
<form class="search_form" name="form1" action="report!arrearageArea.action" method="post">
 ...
 <div class="main_right fl">
   	<div class="table_area">
           <div class="table_name">
              <p>截止至<U><%=endYearMonth%></U>&nbsp;&nbsp;&nbsp;&nbsp;物业费欠费统计表</p> 
           </div>
           <table class="table_border" width="99%" cellpadding="2" cellspacing="1" align="center">
            ...
            <tr>
				    ...
				    <td class="td_c"><a href="report!arrearageEdifice.action?areaId=<s:property value="viewList[#stuts.index][0]"/>&endYearMonth=<%=endYearMonth%>&areaName=<s:property value="viewList[#stuts.index][1]"/>"><s:property value="viewList[#stuts.index][1]"/></a></td>
