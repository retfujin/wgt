   	...
   	<div class="table_area">
    	...
    	<td class="td_header" >补交<%=nowYear %>年前金额</td>
            ...
            <tr>
				...
				<td class="td_c"><a href="report!monthhousereport.action?edificeId=<s:property value="viewList[#stuts.index][10]"/>&startDate=<%=startDate%>&endDate=<%=endDate%>"><s:property value="viewList[#stuts.index][0]"/></a></td>
