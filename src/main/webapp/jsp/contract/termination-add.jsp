...
<body>
    <div class="add">
    	<div class="add_area">
		  ...
		  <tr>
		  	<td colspan="4">你与公司<s:textfield name="entity.begindate" id="begindate" size="10" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  theme="simple"></s:textfield>
		  	...
		  	到期，现公司决定不再与你续订劳动合同。<br>
				请在接到本通知后，至综合部填写《员工离职审批单》，并于<s:textfield name="entity.endworkdate" id="endworkdate" size="10" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  theme="simple"></s:textfield>
				前完成相关工作交接。
 			</td> 
		  </tr>
		  <tr class="footer">
