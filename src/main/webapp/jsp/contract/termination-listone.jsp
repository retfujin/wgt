...
<script type="text/javascript">
	...
	function edit(id) {
		var vReturnValue = window.showModalDialog("termination!editone.action?entity.id=" + id,"",
...
<body>
<form class="search_form" name="form1" action="termination!listone.action" method="post">
   	...
   	<div class="table_area">
           ...
           <div class="table_footer" id="footer">
				...
				<s:if test="page.totalPages>1">
					<a href="termination!listone.action?page.pageNo=1&page.orderBy=${page.orderBy}&page.order=${page.order}">首页</a>
				</s:if><s:else><a href="#">首页</a></s:else>
				<s:if test="page.hasPre">
					<a href="termination!listone.action?page.pageNo=${page.prePage}&page.orderBy=${page.orderBy}&page.order=${page.order}">上一页</a>
				</s:if><s:else><a href="#">上一页</a></s:else>
				<s:if test="page.hasNext">
					<a href="termination!listone.action?page.pageNo=${page.nextPage}&page.orderBy=${page.orderBy}&page.order=${page.order}">下一页</a>
				</s:if><s:else><a href="#">下一页</a></s:else>
				<s:if test="page.totalPages>1">
					<a href="termination!listone.action?page.pageNo=${page.totalPages}&page.orderBy=${page.orderBy}&page.order=${page.order}">尾页</a>
