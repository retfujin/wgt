...
<tr>
	<td width="80">审批结果</td><td><s:if test="#modules.state==0"><font color="green">待审批</font></s:if><s:elseif test="#modules.state==1">审批通过</s:elseif><s:elseif test="#modules.state==2"><font color="red">不通过</font></s:elseif></td>
