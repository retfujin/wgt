...
$(document).ready(function(){
	...
	//	border:'none',
		...
		items : [{
			...
			html:'<iframe id="tab1Frame" src="/sys/process!waitapprovallist.action?processType=jhlc" width="100%" height="100%" frameborder="0"></iframe>',
			closable: true
		},{
			id:'tab2',
			title:'已审批',
			icon:'/tabpanel/image/read-y.gif',
			html:'<iframe id="tab2Frame" src="/sys/process!endapprovallist.action?processType=jhlc" width="100%" height="100%" frameborder="0"></iframe>',
			closable: true
		}]
	});
});
