...
<div class="add">
    	<div class="add_area">
            ...
            <form id="ff" method="post" action="repair!save1.action" name="formadd" >
                ...
                <table class="add_table" cellpadding="2" cellspacing="1" align="center" width="99%" align="center" >
                    <tr>
					  ...
					  <tr>
					  	...
					  	<td colspan="3"><s:textarea name="customerrepair.repairprocess" id="repairprocess" rows="2" cols="50" cssClass="con_input_con" theme="simple"/>可不填写</td>
					  </tr>
					 <tr>
		...
		$(function(){
			$('#ff').form({
				onSubmit: function(){
					...
					var item = $('input[name="customerrepair.repairStatus"][checked]').val();
