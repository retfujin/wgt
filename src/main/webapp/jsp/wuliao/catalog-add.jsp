            ...
            <form id="ff" method="post" action="catalog!save.action" name="frmAdd">
                <table class="add_table" cellpadding="2" cellspacing="1" align="center" width="99%" align="center" >
                    <tr>
					    ...
					    <td><s:hidden name="add" value="tadd"></s:hidden>
					    <s:textfield  name="e.id" id="id" size="10" theme="simple" /></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><select name="e.wlAssortmentEO.id" id="wlAssortmentEOId">
