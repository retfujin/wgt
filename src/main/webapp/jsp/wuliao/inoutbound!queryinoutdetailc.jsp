...
<TR>
    <TH height=25 align="left">出入库明细查询</TH>
</TR>
</table>
  <form method="post" action="inoutbound!queryInOutDetailR.action" name="frmAdd" onSubmit="return frmOnAdd(this)">
    ...
    <tr>
     ...
     <tr>
    	<td width="20%" height="30"  align="right">物料名称(模糊匹配)：&nbsp;</td>
    	<td width="30%">
			<input type="text" name="wlName" />
		</td>
    </tr>
    <tr>
