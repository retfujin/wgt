...
<script type="text/javascript">
 ...
 <%@ include file="/menubar/simple/aa.jsp" %> 
  ...
  <TBODY>
<TR>
    <TH height=25 align="left">添加领料退库单<span class="样式1"><font style="font-size: 9pt"></font></span></TH>
</TR></tbody>
</table>
<form method="post" id="ff" action="inoutbound!savece.action" name="frmAdd">
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablegray" id="edittable">
  
  <tr>	
  	<td height="28">出库单号：<s:textfield name="e.bh" id="bh" value="%{newBh}" size="25" theme="simple" readonly="true" /></td>
  ...
  <tr>	
  	<td height="28">客户名称：<s:textfield  name="e.customName" id="customName" size="25" maxlength="20" theme="simple"/><font color="red">*</font></td>
    <td>经&nbsp;&nbsp;办&nbsp;&nbsp;人：<s:textfield  name="e.purchaseP" id="purchaseP" size="14" maxlength="20" theme="simple"/><font color="red">*</font></td>
 </tr>
  <tr>
  	<td colspan="3" height="28">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：<s:textfield  name="e.remarks" id="remarks" size="57" maxlength="100" theme="simple"/></td>
 </tr>
  <tr>
