...
<table width="97%" border="0" cellspacing="0" cellpadding="0" align=center class="tableBorder1">
	<TBODY>
		<TR><TH height=25 align="left">添加领料出库单<span class="样式1"><font style="font-size: 9pt"></font></span></TH></TR>
	</tbody>
</table>
<form method="post" id="ff" action="inoutbound!saveck.action" name="frmAdd" >
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablegray" id="edittable">
  
  <tr>	
  	<td height="28">出库单号：<s:textfield name="e.bh" id="bh" value="%{newBh}" size="20" theme="simple" readonly="true" /></td>
    ...
    <td>出库日期：<s:textfield  name="e.rq" id="rq" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" size="12" readonly="true" theme="simple"/><font color="red">*</font></td>
 </tr>
  <tr>	
  	<td height="28">客户名称：<s:textfield  name="e.customName" id="customName" size="20" maxlength="20" theme="simple"/><font color="red">*</font></td>
    <td>发票类型：<s:select name="e.InvNum" list="#{'普通发票':'普通发票','增值税发票':'增值税发票'}" theme="simple"></s:select><font color="red">*</font></td>
    <td>经办人：<s:textfield  name="e.purchaseP" id="purchaseP" size="15" maxlength="20" theme="simple"/><font color="red">*</font></td>
 </tr>
  <tr>
  	<td colspan="3" height="28">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：<s:textfield  name="e.remarks" id="remarks" size="55" maxlength="100" theme="simple"/></td>
 </tr>
  <tr>
