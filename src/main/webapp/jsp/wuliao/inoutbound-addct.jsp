...
<script type="text/javascript">
 ...
 <%@ include file="/menubar/simple/aa.jsp" %> 
  ...
  <TBODY>
<TR>
    <TH height="35" align="left">添加退货出库单<span class="样式1"><font style="font-size: 9pt"></font></span></TH>
</TR></tbody>
</table>
<form method="post" id="ff" action="inoutbound!savect.action" name="frmAdd">
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablegray" id="edittable">
  
  <tr>	
  	<td height="28">退库单号：<s:textfield name="e.bh" id="bh" value="%{newBh}" size="20" theme="simple" readonly="true" /></td>
  ...
  <tr>
  	<td>退库日期：<s:textfield  name="e.rq" id="rq" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="true" size="20" theme="simple"/><font color="red">*</font></td>
  ...
  <tr>
  	<td height="28" colspan="3">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：<s:textfield  name="e.remarks" id="remarks" size="55" maxlength="100" theme="simple"/></td>
 </tr>
  <tr>
