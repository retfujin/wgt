...
<script type="text/javascript">
  ...
  <body>
<%
      String[] menuModel = {"menuModel2.addItem(203,'建账入库','','inoutbound!addrj.action',false);"
 ...
 <%@ include file="/menubar/simple/aa.jsp" %>  
  ...
  <TBODY>
<TR>
    <TH height="25" align="left">添加建账入库单<span class="样式1"><font style="font-size: 9pt"></font></span></TH>
</TR></tbody>
</table>
<form id="ff" method="post" action="inoutbound!saverj.action" name="frmAdd">
<table width="97%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablegray" id="edittable">
  ...
  <td>建账日期：<s:textfield  name="e.rq" id="rq" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" size="12" readonly="true" theme="simple"/><font color="red">*</font></td>
 </tr>
  <tr>
  	<td colspan="3" height="28">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：<s:textfield  name="e.remarks" id="remarks" size="51" maxlength="100" theme="simple"/></td>
 </tr>
  <tr>
