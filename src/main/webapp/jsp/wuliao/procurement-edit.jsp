    	...
    	<div class="add_area">
		  ...
		  <tr>
		    <td >
		    	...
		    	<input type="text" name="goodsname" value="${goodsname}" /> </td>
		    <td ><input type="text"  name="unit" value="${unit}" size="10" /> </td>
		    <td ><input type="text"  name="num" value="${num}" size="10"/> </td>
		    <td ><input type="text"  name="brand" value="${brand}" size="10" /> </td>
		    <td ><input type="text"  name="price" value="${price}" size="8"/> </td>
		    <td ><input type="text"  name="inuse" value="${inuse}" size="30"/> </td>
		  </tr>
		   </s:iterator>
		  <tr class="footer">
                        <td colspan="6">
