...
DHTMLSuite.config.prototype = {
	...
	init : function()
	{
//		this.imagePath = '/wgt/menubar/images_dhtmlsuite/';	// Path to images		
//		this.cssPath = '/wgt/menubar/css_dhtmlsuite/';	// Path to images		
		this.imagePath = '/menubar/images_dhtmlsuite/';	// Path to images		
		this.cssPath = '/menubar/css_dhtmlsuite/';	// Path to images		
